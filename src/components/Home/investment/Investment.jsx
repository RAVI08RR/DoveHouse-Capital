...
function Investment(props) {
    ...
    const handleEndScroll = () => {
        if (scrollDivRef.current) {
            ...
            if (scrollDivRef.current.scrollTop == 0 && investmentRef.current.snapPosition == 0) {
                props.navigate(-1);
            }
            if (scrollDivRef.current.scrollTop > 0 && investmentRef.current.snapPosition == 1) {
                props.navigate(1);
            }
    ...
    return <div className='investment-wrapper' ref={scrollDivRef} onTouchEnd={handleScrollEvent} onWheel={handleScrollEvent} onScroll={handleScrollEnd}>
        <div className='investment-container'>
            ...
            <motion.div
                ...
                <div className='investment-bg flex justify-center items-center' style={{ backgroundImage: `url(${img_investmentapproach_img})` }}>
                    <p className='bg-text'>
        ...
        <motion.div
            ...
            <p className='paragraph-gap'>
                We combine a high level of expertise and experience across all functions and leverage well-defined and rigorous investment approaches built on key pillars.
            </p>
            <p className='paragraph-gap'>
                Across our three core investment strategies we have one singular focus: delivering optimal and accessible risk-adjusted returns for our investors.
            </p>
            <motion.div
                animate={controls}
            ...
            >
                <a
                    ...
                    href='#' className='investment-learn-more'> Learn more</a>
            </motion.div>
