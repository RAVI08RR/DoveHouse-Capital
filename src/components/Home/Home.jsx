...
function Home(props) {
    ...
    if (!imagesLoaded) {
        ...
        return (<div className='flex justify-center w-full h-lvh items-center'>
    ...
    return (<>
        <motion.div className="progress-bar" transition={{ ease: "easeOut", duration: 2 }} style={{ height: spring }} />
        <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onWheel={handleWheelChange} className={`home-container section-${currentSection}`}>
            <header class="header">
                <div class="inner-content">
                    <svg onClick={() => { props.toggleDrawer() }} xmlns="http://www.w3.org/2000/svg" width="57" height="21" viewBox="0 0 57 21" fill="none">
                        <rect width="57" height="1.09524" fill="#203468"></rect>
                        <rect y="9.95312" width="57" height="1.09524" fill="#203468"></rect>
                        <rect y="19.9043" width="57" height="1.09524" fill="#203468"></rect>
                    </svg>
                </div>
            </header>
            <main>
                                ...
                                {currentSection == 2 &&
                                    <motion.div
                                        ...
                                        <motion.div
                                            ...
                                            class="wrapper-block">
                                            <div class="menu">
                                                <Icon_Menu onClick={() => { props.toggleDrawer() }}></Icon_Menu>
                                            </div>
                                        </motion.div>
                                        <div class="inner-content">
                                            <motion.p
                                                ...
                                                class="title font-primary text-white">Investment Leader, Diverse <br />Strategies
                                                Worldwide</motion.p>
                                            <motion.p
                                                transition={{ ease: "easeIn", duration: .7, delay: 1.7 }}
                                                whileInView={{ opacity: 1, y: 0 }}
                                                ...
                                                class="font-secondary text-grey subtitle">We aim to democratize hedge fund access,
                                                offering transparent, <br />AI-driven strategies for benchmark-beating returns.</motion.p>
                                        </div>
                ...
                {isMobileView && currentSection >= 3 && <section id="section-3" className={`sec-content ${currentSection >= 3 ? "active-section" : ""}`} >
                ...
                {!isMobileView && currentSection == 4 && <section id="section-4" className={`sec-content ${currentSection == 4 ? "active-section" : ""}`}>
                    <Investment navigate={handleNavigation}></Investment>
                </section>}
                {!isMobileView && currentSection == 5 && <section id="section-5" className={`sec-content ${currentSection == 5 ? "active-section" : ""}`}>
                    <Leadership></Leadership>
                </section>}
                {!isMobileView && currentSection == 6 && <section id="section-6" className={`sec-content ${currentSection == 6 ? "active-section" : ""}`}>
