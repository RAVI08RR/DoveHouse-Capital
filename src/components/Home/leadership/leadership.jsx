        ...
        <div className='leadership-container' >
            ...
            <div className='leadership-image-div'>
                <motion.div
                    ...
                    className='leadership-bg flex items-center sm:bg-cover lg:bg-contain' style={{ background: `url(${img_leadership_bg}) lightgray 50% / cover no-repeat` }}>
                    <div className='md:ml-20'>
                        ...
                        >
                            ...
                            <p className='leadership-heading'>
                                LEADERSHIP
                            </p>
                            <p className='leadership-title paragraph-gap'>
                                leading <br></br> <span className='text-white'>investment</span> firm.
                            </p>

                        </motion.div>
                        <motion.p
                            transition={{ ease: "easeOut", duration: .7, delay: 2 }}
                        ...
                        <motion.div
                            ...
                            <a href='#' className='investment-learn-more mb-20'> Learn more</a>
                        </motion.div>
